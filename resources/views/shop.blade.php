            ...
            <div class="col-lg-3 col-12">
                <div class="row mx-0">
                    <div class="col-12 card bg-light mx-auto">
                        <p style="margin-top:1rem;"><a href="">PDF</a></p>
                        <hr style="margin: 0;">
                        <p style="margin-top:1rem;"><a href="">Audio</a></p>
                        <hr style="margin: 0;">
                        <p style="margin-top:1rem;"><a href="">Video</a></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-9 col-12">
                <div class="row">
                    <div class="col-md-4 pb-1 pb-md-0">
                        <div class="card"> <img class="card-img-top" src="images/banner.jpeg" alt="Card image cap">
                            <div class="card-body">
