...
<body>
    ...
    <div class="container" style="min-height: 575px;">
        <div class="row">
            <div class="col-lg-4 col-12 offset-3">
                <div class="row mx-0">
                    <div class="col-12 card bg-light mx-auto">
                        <h3 class="text-center card-header">Payment</h3>
                        <form class="card-body row">
                           <input type="radio" id="Paypay" name="payment" value="paypal">
  <label for="paypal">Paypal</label><br></br>
  <input type="radio" id="Stripe" name="payment" value="Stripe">
  <label for="stripe">Stripe</label><br>
  <input type="radio" id="Square" name="payment" value="Square">
  <label for="square">Square</label><br>
                            <div class="col-md-12"><a href="thanks.html" class="btn btn-success" style="width: 100%;" role="button">Checkout </a></div>
                        </form>
